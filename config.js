...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~FFBXFYLK#6L3vbgr1f9p-V4d6sLTkUxaYcvOBNK6laP70LMUpcTk",
// add your Session Id 
...
STICKER_NAME: process.env.STICKER_NAME || "Billyched-brown",
